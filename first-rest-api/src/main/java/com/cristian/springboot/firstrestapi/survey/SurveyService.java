...
public class SurveyService {
    ...
    public Question retrieveOneSurveyQuestion(String surveyId, String questionId) {
...
//        if(surveyQuestions == null)
//            return null;
        Predicate<? super Question> predicate = questionPredicate -> questionPredicate.getId().equals(questionId);
